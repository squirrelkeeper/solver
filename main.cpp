...
var derive_test(var&, var&, var&, lpar_dbl_set*, fpar_dbl_set*);
...
//		deriv(dX, X[pos0], X[posT], X[postau], lp, fp);
		...
		dX = derive_test(X[pos0], X[posT], X[postau], lp, fp);
...
/*REPLACE START*/
var derive_test(var &X, var &XT, var &Xtau, lpar_dbl_set *l, fpar_dbl_set *f)
{
	var d;
